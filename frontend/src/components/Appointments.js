...
const Appointments = () => {
  ...
  const handleAddAppointment = (e) => {
    ...
    axios
      .post("http://localhost:8000/appointments/add", newAppointment)
      .then((response) => {
  ...
  const handleUpdateAppointment = (id, e) => {
    ...
    axios
      .post(
        `http://localhost:8000/appointments/update/${id}`,
        selectedAppointment
      )
      .then((response) => {
        const updateApp = {
  ...
  const handleDeleteAppointment = (id) => {
    axios
      .delete(`http://localhost:8000/appointments/delete/${id}`)
      .then((response) => {
        setAppointments(
    ...
    <div className="flex-row" style={{ width: "100%" }}>
      <div className="flex-column">
        <div className="add-form">
          <h4>{isEditMode ? "EditAppointment" : "Add New Appointment"}</h4>
          <form
